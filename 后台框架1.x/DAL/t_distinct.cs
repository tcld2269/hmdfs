...
namespace hm.DAL
{
	...
	public partial class t_distinct
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "t_distinct"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from t_distinct");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update t_distinct set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from t_distinct ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public hm.Model.t_distinct GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,code,name,cityCode from t_distinct ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			hm.Model.t_distinct model=new hm.Model.t_distinct();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,code,name,cityCode ");
			strSql.Append(" FROM t_distinct ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,code,name,cityCode ");
			strSql.Append(" FROM t_distinct ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
