...
namespace hm.DAL
{
	...
	public partial class t_city
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "t_city"); 
		}
		...
		public int Add(hm.Model.t_city model)
		{
			...
			strSql.Append("code,name,provinceCode)");
		...
		public hm.Model.t_city GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,code,name,provinceCode from t_city ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			hm.Model.t_city model=new hm.Model.t_city();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,code,name,provinceCode ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,code,name,provinceCode ");
			strSql.Append(" FROM t_city ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
