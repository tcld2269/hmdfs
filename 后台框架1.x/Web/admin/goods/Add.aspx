<%@ Page Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="hm.Web.goods.Add" Title="增加页" ValidateRequest="false"  %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                            商品图片：</label>
                        <div class="col-sm-8">
                            <asp:FileUpload ID="flPic" runat="server"  CssClass="form-control" Width="300px"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
