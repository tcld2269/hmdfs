<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="hm.Web.admin.test" %>
...
<script src="/admin/js/content.min.js?v=1.0.0"></script>
    ...
    <script src="/admin/js/plugins/summernote/summernote-zh-CN.js"></script>
    <script>
