<%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="hm.Web.sysItem.Modify" Title="修改页" %>
...
<table width="100%" border="0" cellpadding="4" cellspacing="1" class="show-table">
	...
	<td height="25" width="*" align="left">
		<asp:label id="lblsiId" runat="server"></asp:label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		字典项
