<%@ Page Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="hm.Web.news.Modify" Title="修改页" ValidateRequest="false"%>
            ...
            <div class="ibox-content">
                <div class="form-horizontal">
                    ...
                    OnClick="btnSave_Click" class="inputbutton" CssClass="btn btn-warning"></asp:Button>
                            <button id="btncancle" class="btn btn-default" type="button" onclick="history.back()">
                                取消</button>
                        </div>
                    </div>
                </div>
