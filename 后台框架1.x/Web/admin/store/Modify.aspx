<%@ Page Language="C#" MasterPageFile="~/admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="Modify.aspx.cs" Inherits="hm.Web.store.Modify" Title="增加页" ValidateRequest="false" %>
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                            企业名称：</label>
                        <div class="col-sm-8">
                            <asp:TextBox ID="txtStoreName" runat="server" CssClass="form-control" required=""
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                            企业类型：</label>
                        <div class="col-sm-8">
                            <asp:DropDownList ID="ddrCat" runat="server" CssClass="form-control">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select id="distinct" class="form-control sel-ads hide" onchange="showLast()">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
...
<asp:Content ID="Content2" ContentPlaceHolderID="foot" runat="server">
    ...
    //给select赋值
    $("#province").val(<%=provinceString %>);
    showCity();
    $("#city").val(<%=cityString %>);
    showDistinct();
    $("#distinct").val(<%=distinctString %>);
    $("#addressVal").val(<%=distinctString %>)
